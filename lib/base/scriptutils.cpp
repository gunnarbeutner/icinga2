...
{
	ScriptGlobal::Set("Constants.MatchAll", MatchAll);
	ScriptGlobal::Set("Constants.MatchAny", MatchAny);

	ScriptGlobal::Set("Constants.GlobFile", GlobFile);
	ScriptGlobal::Set("Constants.GlobDirectory", GlobDirectory);
}
